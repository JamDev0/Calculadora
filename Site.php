	...
	<body>
		...
		<div id="Mostrador">
			...
			<script type="text/javascript">
				...
				var coord3 = "" + largura*0.1055 + "," + altura*0.7928 + "," + largura*0.2670 + "," + altura*0.9253 + "";
				...
				var coord12 = "" + largura*0.3115 + "," + altura*0.7934 + "," + largura*0.4730 + "," + altura*0.9246 + "";
				var coord13 = "" + largura*0.5224 + "," + altura*0.7937 + "," + largura*0.6827 + "," + altura*0.9359 + "";
				...
				var coord17 = "" + largura*0.7284 + "," + altura*0.4671 + "," + largura*0.8891 + "," + altura*0.6012 + "";
				...
				function função7() 
				{
					window.location.href = "Calculadora2.php"
				}
				...
				function função14() 
				{
					...
					switch (quarto) 
						...
						var ReM = document.createElement("p");
						var Remm = document.createTextNode(resulta2);
						ReM.appendChild(Remm);
					}
					$(".Numeros").hide();
					var identificação = document.createAttribute("class");
				...
				function função17() 
				{
					...
					var Oito = document.createTextNode("X");
					var p = document.createElement("p");
					var identificação = document.createAttribute("class");
					identificação.value= "Numeros";
					p.setAttributeNode(identificação);
